...
object WhiteDnsDesignTokens {
    private val Light = WhiteDnsPalette(
        ...
        surfaceElevated1 = 0xFFF8FAFD.toInt(),
        surfaceElevated2 = 0xFFEDF2F9.toInt(),
        surfaceVariant = 0xFFE6EAF2.toInt(),
        textPrimary = 0xFF0C121D.toInt(),
        textSecondary = 0xFF4A5568.toInt(),
        textTertiary = 0xFF718096.toInt(),
        neutral = 0xFF4A5568.toInt(),
        outline = 0xFFD2D9E5.toInt(),
        teal = 0xFF0066FF.toInt(),
        amber = 0xFFFF9500.toInt(),
        red = 0xFFFF3B30.toInt(),
        onAccent = 0xFFFFFFFF.toInt(),
        onProminent = 0xFFFFFFFF.toInt(),
        onStateFill = 0xFFFFFFFF.toInt(),
        brandPillBackground = 0xFFE5EFFF.toInt(),
        brandPillOutline = 0xFF99C2FF.toInt(),
        amberTrack = 0xFFFFF3DC.toInt(),
        redTrack = 0xFFFFE8E6.toInt(),
        idleRing = 0xFFCBD5E1.toInt(),
        majorTick = 0xFF94A3B8.toInt(),
        tealGradientStart = 0xFF0066FF.toInt(),
        tealGradientEnd = 0xFF00C6FF.toInt(),
        amberGradientStart = 0xFFFFB340.toInt(),
        amberGradientEnd = 0xFFFF9500.toInt(),
        redGradientStart = 0xFFFF6961.toInt(),
        redGradientEnd = 0xFFFF3B30.toInt(),
    )

    private val Dark = WhiteDnsPalette(
        isDark = true,
        background = 0xFF000000.toInt(),
        surface = 0xFF0A0E17.toInt(),
        surfaceElevated1 = 0xFF101624.toInt(),
        surfaceElevated2 = 0xFF182033.toInt(),
        surfaceVariant = 0xFF202B42.toInt(),
        textPrimary = 0xFFF5F8FC.toInt(),
        textSecondary = 0xFFA2B0C4.toInt(),
        textTertiary = 0xFF6C7D93.toInt(),
        neutral = 0xFF8899B0.toInt(),
        outline = 0xFF1F293D.toInt(),
        teal = 0xFF0A84FF.toInt(),
        amber = 0xFFFF9F0A.toInt(),
        red = 0xFFFF453A.toInt(),
        onAccent = 0xFFFFFFFF.toInt(),
        onProminent = 0xFFFFFFFF.toInt(),
        onStateFill = 0xFFFFFFFF.toInt(),
        brandPillBackground = 0xFF0E2A50.toInt(),
        brandPillOutline = 0xFF1D5AA6.toInt(),
        amberTrack = 0xFF3D2600.toInt(),
        redTrack = 0xFF421210.toInt(),
        idleRing = 0xFF1E283C.toInt(),
        majorTick = 0xFF344563.toInt(),
        tealGradientStart = 0xFF0A84FF.toInt(),
        tealGradientEnd = 0xFF64D2FF.toInt(),
        amberGradientStart = 0xFFFFB340.toInt(),
        amberGradientEnd = 0xFFFF9F0A.toInt(),
        redGradientStart = 0xFFFF6961.toInt(),
        redGradientEnd = 0xFFFF453A.toInt(),
    )
...
class DashboardDataRowView(context: Context) : LinearLayout(context) {
    ...
    override fun dispatchSetPressed(pressed: Boolean) {
        ...
        if (isClickable && ValueAnimator.areAnimatorsEnabled()) {
            animate()
                .scaleX(if (pressed) 0.98f else 1f)
                .scaleY(if (pressed) 0.98f else 1f)
                .setDuration(if (pressed) 100L else 240L)
                .setInterpolator(
                    if (pressed)
                        android.view.animation.PathInterpolator(0.2f, 0f, 0f, 1f)
                    else
                        android.view.animation.PathInterpolator(0.2f, 1.3f, 0.4f, 1f)
                )
                .start()
        }
    }
